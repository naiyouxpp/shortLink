...
import project.dao.entity.LinkOsStatsDO;
...
public interface LinkOsStatsMapper extends BaseMapper<LinkOsStatsDO> {
     ...
     */
    @Insert("INSERT INTO " +
            "t_link_os_stats (full_short_url, date, cnt, os, gid, create_time, update_time, del_flag) " +
            "VALUES( #{linkOsStats.fullShortUrl}, #{linkOsStats.date}, #{linkOsStats.cnt}, #{linkOsStats.os}, #{linkOsStats.gid}, NOW(), NOW(), 0) " +
